...
async function startnaimi() {
    const naimi = naimiConnect({
        ...
        browser: ['Lanzz Multi Device','Safari','1.0.0'],
        auth: state,
...
let buttonMessage = {
document: fs.readFileSync('./karuta/lanzzstore.xlsx'),
mimetype: docs,
...
mediaType:2,
thumbnail: ppusernya,
sourceUrl: `https://instagram.com/mf4dhlan_24`,
...
naimi.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await naimi.getName(i + '@s.whatsapp.net')}\nFN:${setting.ownerName}\nORG:${setting.deskripsi};\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:fadhlanmhmd24@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/mf4dhlan_24\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
